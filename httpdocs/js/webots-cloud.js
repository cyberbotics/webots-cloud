...
document.addEventListener('DOMContentLoaded', function() {
  ...
  function homePage(project) {
    ...
    document.getElementById("scene-sort-select").addEventListener('touchstart', function(event) {
      const sortBy = document.getElementById("scene-sort-select").value;
      listAnimations('S', scenePage, sortBy);
    });
    document.getElementById("animation-sort-select").addEventListener('touchstart', function(event) {
      const sortBy = document.getElementById("animation-sort-select").value;
      listAnimations('A', animationPage, sortBy);
    });
    document.getElementById("simulation-sort-select").addEventListener('touchstart', function(event) {
    ...
    function updatePagination(tab, current, max) {
      console.log("tab: " + tab + " // current: " + current + " // max" + max);
