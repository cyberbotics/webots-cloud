<?php # This script list available animations (or scenes)
  ...
  if (isset($data->url)) { // view request
    ...
    if (isset($data->search)) {
      ...
      $query = "SELECT * FROM animation WHERE $extra_condition AND CHARINDEX('Village', title) > 0 AND uploading = 0 ORDER BY $parameter $order, id ASC LIMIT $limit OFFSET $offset";
    } else
