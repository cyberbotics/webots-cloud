...
2. Registers a [deploy key](https://docs.github.com/en/free-pro-team@latest/developers/overview/managing-deploy-keys) with the public key of the competition so that the competition can clone the private repository of the competitor.
